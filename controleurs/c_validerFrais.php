...
switch ($action) {
	...
	case 'majFraisForfait': {
			...
			if (lesQteFraisValides($lesFraisForfait)) {
				...
				$montantTotalFraisForfait = $pdo->getMontantTotalFraisForfait($idVisiteur, $leMois);
				$montantTotalHorsFraisForfait = $pdo->getMontantTotalFraisHorsForfait($idVisiteur, $leMois);
				$montant = $montantTotalFraisForfait['montant'] + $montantTotalHorsFraisForfait['montant'];
